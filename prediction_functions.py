...
def save_prediction_csv(t_pred, y_hat, pred_error_x, pred_error_y, prediction_history, FOWT_pred_state, save_time, required_measurements, data_source):
    ...
    prediction_history_path = os.path.join(prediction_results_dir, f"PRED_HISTORY_{save_time_str}s_{source_tag}_ACTIVE.csv")
...
def active_pred_plot(t_pred, y_hat, pred_error_x, pred_error_y, data_frame_inputs, current_time, dol, time_data, t1_idx, t2, t1, fig, ax, FOWT_pred_state, save_final_plot=True):
