...
# === CONFIGURATION ===
input_h5_path = r"C:\Users\marku\Documents\DT_prediction_model\DOLPHINN\data\Con_set_Ts_025_180.h5"
output_csv_path = r"C:\Users\marku\Documents\DT_prediction_model\DOLPHINN\data\Con_set_Ts_025_180.csv"
...
floater_path = base_path + "_Floater.csv"
sov_path = base_path + "_SOV.csv"
...
gangway_motion_path = base_path + "_Gangway.csv"
combined_gangway_metrics.to_csv(gangway_motion_path, index=False)
print(f"Gangway motion CSV saved at: {gangway_motion_path}")
