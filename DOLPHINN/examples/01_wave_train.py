...
# # ---------------- OFFSET FOR GNAGWAY MOTIONS --------------------
# # --- Optional Offset Correction for Training Visualization ---
# offset_steps = 12  # e.g., shift 20 seconds earlier
# for i in range(y_hat.shape[1]):
#     y_hat[:, i] = np.roll(y_hat[:, i], -offset_steps)

# # Zero out the tail to avoid circular artifacts
# y_hat[-offset_steps:, :] = np.nan
